...
function updateRange() {
    ...
    lowValue.style.backgroundColor = "#ef7b54";

    const space = document.getElementById('space');
    space.style.flex = high - low + "%";
    space.style.backgroundColor = "#83e1d0";

    const highValue = document.getElementById('high');
    highValue.style.flex = 100 - high + "%";
    highValue.style.backgroundColor = "#ef7b54";
...
function compareGuess() {
    ...
    if (attempts < maxGuesses) {
        ...
        if (userGuess > computerGuess) {
            ...
            document.getElementById("textOutput").innerHTML = "Correct! You got it on the last " + attempts + "th attempt.";
            gameEnded();
        }
    }
    updateRange();
